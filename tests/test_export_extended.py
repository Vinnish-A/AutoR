...
from autor.export import export_markdown_refs, export_ris, meta_to_ris
...
class TestCitationStyles:
    ...
    def test_list_styles_includes_builtins(self, tmp_papers):
        from autor.citation_styles import BUILTIN_STYLES, list_styles
    ...
    def test_get_formatter_builtin(self):
        from autor.citation_styles import get_formatter
        from autor.config import Config
    ...
    def test_custom_style_loaded_from_file(self, tmp_path):
        from autor.citation_styles import get_formatter, list_styles
        from autor.config import Config
