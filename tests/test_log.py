"""Tests for autor.log — logging setup, session ID, ui()."""
...
from autor.log import get_logger, get_session_id, reset, setup, ui
...
class TestUI:
    def test_ui_no_args(self, caplog):
        with caplog.at_level(logging.INFO, logger="autor.ui"):
            ui()
        # Should not crash
